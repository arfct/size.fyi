...
export default function ViewTabs() {
  ...
  return (
    <div
      role="tablist"
      aria-label="View"
      className="pointer-events-auto absolute left-1/2 top-3 z-10 inline-flex -translate-x-1/2 rounded-full bg-white/70 p-0.5 shadow-sm backdrop-blur dark:bg-stone-900/70"
    >
      {VIEWS.map((v) => (
